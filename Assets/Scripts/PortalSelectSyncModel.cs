...
{
    [RealtimeModel]
    public partial class PortalSelectSyncModel
    {
...
namespace Assets.Scripts {
    public partial class PortalSelectSyncModel : RealtimeModel {
        ...
        public delegate void PropertyChangedHandler<in T>(PortalSelectSyncModel model, T value);
        ...
        public PortalSelectSyncModel() : this(null) {
        }
        
        public PortalSelectSyncModel(RealtimeModel parent) : base(null, parent) {
        }
